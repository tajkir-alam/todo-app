...
const Task = () => {
    ...
    return (
        tasks.filter((task)=> task.status === 'in-completed').map(({ id, taskTitle, taskDescription, status, deadLines, priority }) => (
            <div key={id} className='bg-[#f0f6ff] py-3 px-4 rounded-lg space-y-4'>
